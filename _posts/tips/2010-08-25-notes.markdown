...
person tries to push thier notes it will look like a non-fast-forward just 
...
So far, I've heard of people using them to have thier ticketing system attach 
