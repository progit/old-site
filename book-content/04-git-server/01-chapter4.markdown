...
If you’re using a version of Git earlier than 1.6, the mv command isn’t necessary—Got started naming the hooks examples with the .sample postfix only recently. 
